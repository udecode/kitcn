...
For `better-convex init -t next`, shadcn owns the app shell. Better Convex
...
Better Convex-owned files stay Better Convex-owned:
...
- same shadcn shell, Better Convex files mounted through minimal patches
