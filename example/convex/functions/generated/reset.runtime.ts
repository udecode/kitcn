...
const procedureRegistry = {
  "deleteTable": ["mutation", typedProcedureResolver(internal["reset"]["deleteTable"], () => (require("../reset") as Record<string, unknown>)["deleteTable"])],
  "reset": ["action", typedProcedureResolver(internal["reset"]["reset"], () => (require("../reset") as Record<string, unknown>)["reset"])],
} as const;
...
export function createResetCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
  return createCallerFromRegistry(ctx) as GeneratedProcedureCaller<TCtx>;
}

export function createResetHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
