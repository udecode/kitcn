...
const procedureRegistry = {
  "getSnapshot": ["query", typedProcedureResolver(getGeneratedFunctionReference(api["triggerDemo"]["getSnapshot"]), () => (require("../triggerDemo") as Record<string, unknown>)["getSnapshot"])],
  "runCoverage": ["mutation", typedProcedureResolver(getGeneratedFunctionReference(api["triggerDemo"]["runCoverage"]), () => (require("../triggerDemo") as Record<string, unknown>)["runCoverage"])],
} as const;
