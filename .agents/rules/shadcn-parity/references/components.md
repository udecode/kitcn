...
**For comprehensive usage patterns and examples, see the Data Attribute Styling Patterns section in [react.md](./react.md), which covers:**

- Styling with `data-state` (Tailwind arbitrary variants)
- Radix UI data attributes
- Using `data-slot` with `has-[]` and `**:` selectors
- Global CSS patterns
...
**For practical implementation and examples, see the Design Tokens section in [react.md](./react.md), which covers:**
