---
description: TanStack Query ownership for kitcn cRPC queries, mutations, live Convex subscriptions, RSC preloading, cache keys, and bounded invalidation.
name: react-query
metadata:
  skiller:
    source: .agents/rules/react-query.mdc
---
