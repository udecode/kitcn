...
| Invite emails never send                                                              | Resend plugin not registered or scaffold missing                                                 | Add `resendPlugin()` in `schema.ts`, run `better-convex add resend`, and wire `internal.plugins.email.sendTemplatedEmail`                                                                  |
