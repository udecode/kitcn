...
1. Scaffold the local schema extension so internal storage tables exist.
2. Add one local ratelimit plugin that owns buckets and policy.
3. Wire that plugin into middleware so handlers stay focused.
