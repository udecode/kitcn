...
Fresh TanStack Start, Vite, and Expo starters are also available through
`kitcn init -t start --yes`, `kitcn init -t vite --yes`, and
`kitcn init -t expo --yes`.

If you want the native-first path, use [/docs/expo](/docs/expo) instead of
forcing the Next quickstart into a mobile app.
