...
A one-to-one relation connects exactly one record in each table:
...
You can define relations where a table references itself:
...
The ORM supports Drizzle-style relation loading:
