...
The callback shape mirrors Drizzle's relation builder, but in Better Convex you attach relations directly to the default schema export with `.relations(...)`.
...
import { convexTable, defineSchema, id, text } from 'better-convex/orm';
...
import { convexTable, defineSchema, text, id } from 'better-convex/orm';
...
import { convexTable, defineSchema, text, boolean, id } from 'better-convex/orm';
...
import { convexTable, defineSchema, id, integer, text } from 'better-convex/orm';
...
import { boolean, convexTable, defineSchema, id, text } from 'better-convex/orm';
...
import { defineSchema, defineRelationsPart } from 'better-convex/orm';
...
| Issue | Solution |
|-------|----------|
| **Relations not working** | Define relations in `defineSchema(...).relations(...)` and verify both sides (or explicit `from`/`to`) |
