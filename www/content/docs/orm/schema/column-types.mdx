...
import { convexTable, text, integer, InferInsertModel, InferSelectModel } from 'kitcn/orm';
...
import { convexTable, json, text, timestamp } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, textEnum } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, integer } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, date } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, timestamp } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, boolean } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, bigint } from 'kitcn/orm';
...
```ts showLineNumbers
import { bytes, convexTable } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, vector } from 'kitcn/orm';
...
### `arrayOf(element)` / `objectOf(...)` / `unionOf(...)`

Use these helpers for nested arrays, nested objects, homogeneous records, and scalar unions without importing `v` directly.
...
```ts showLineNumbers
import { convexTable, custom } from 'kitcn/orm';
...
```ts showLineNumbers
import { convexTable, json } from 'kitcn/orm';
