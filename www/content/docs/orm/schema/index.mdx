...
In this guide, we'll learn how to define your database schema. You'll master table definitions with `convexTable`, relation wiring with `.relations(...)`, indexes for performance, and runtime guardrails to keep your queries safe.
...
| Relations | `defineRelations()` | `.relations()` |
