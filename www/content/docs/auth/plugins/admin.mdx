...
In this guide, we'll explore role-based admin features with kitcn. You'll learn to configure the admin plugin, set up role-based access control, and use admin APIs for user management, banning, and impersonation.
