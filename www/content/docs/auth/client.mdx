...
In this guide, we'll explore client-side authentication with kitcn. You'll learn to implement sign in/out flows, use auth state hooks, and render components conditionally based on authentication state.
...
│                                                                              │
│  3. <AppConvexProvider token={token}>                                     │
