...
description: Set up kitcn with Better Auth for a TanStack Start app.
links:
...
In this guide, you'll set up kitcn with Better Auth for a TanStack Start
app.
...
import type { ConvexQueryClient, ConvexReactClient } from "kitcn/react";
...
And finally, we need to use this `AppConvexProvider` in our `__root.tsx`
file:
