...
import { createAuthMutations, useAuth, useFetchAccessToken } from 'kitcn/react';
import type { ReactNode } from 'react';

describe('package entrypoints auth integration', () => {
  test('signUp token seeding from kitcn/react is visible to useAuth under kitcn/auth/client', async () => {
    const client = {
      clearAuth: () => {},
      setAuth: () => {},
    };
