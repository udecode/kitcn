const resolveCrpcImportPath = (functionsDirRelative: string) =>
  functionsDirRelative === 'convex' ? './lib/crpc' : '../lib/crpc';
...
export const INIT_NEXT_MESSAGES_TEMPLATE = renderInitNextMessagesTemplate();
