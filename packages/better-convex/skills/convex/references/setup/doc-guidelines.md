...
- setup == `packages/better-convex/skills/convex/references/setup/*.md`
- features == `packages/better-convex/skills/convex/references/features/*.md`
...
```bash
rg -n "ctx\\.table\\(|ctx\\.table\\b|convex-ents|defineEnt\\(" packages/better-convex/skills/convex/SKILL.md packages/better-convex/skills/convex/references -g '*.md'
```
