...
## Context
This document captures known pain points from community references and Convex team responses, and records mitigation guidance that should be reflected in `better-convex/ratelimit` docs.
...
## Explicit non-goals for `better-convex/ratelimit`
