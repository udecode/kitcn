...
Make `better-convex init` behave like `add` for owned files:
...
- Shadcn parity says Better Convex should patch seams, not clobber the shell.
...
- Cold CLI paths also need the same discipline. Plain `better-convex codegen`
