...
- [ ] Docs style doctrine in the kitcn doc guidelines was read before writing,
      or marked N/A for non-`www/**` docs.
- [ ] Documented behavior or API was verified against current source.
- [ ] Ownership map records package, kitcn skill, app-local, and docs-site
...
- [ ] Plugin docs, if applicable, satisfy kitcn plugin guidance and package
      ownership.
...
| Docs lane shape satisfied | pending | Check the lane-specific structure against kitcn docs guidance or record N/A | pending |
...
| MDX/content parser | pending | Run the relevant `www` docs parser/build for MDX/content changes, or record N/A | pending |
