...
export function createOrmExampleDefaultLimitRegressionTestCaller(_ctx: unknown) {
  throw new Error('[better-convex] Runtime caller is not generated yet. Run better-convex codegen.');
}

export function createOrmExampleDefaultLimitRegressionTestHandler(_ctx: unknown) {
